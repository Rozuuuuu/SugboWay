...
VALUES
    ...
    ('stop_minglanilla', 'Minglanilla Town Plaza', 10.2458, 123.7969)
...
VALUES
    ...
    ('route_62b', 'CCT', '62B', 'Minglanilla - Colon via SRP', 3, false, 9200, 'urban', 5500)
...
VALUES
    ...
    ('trip_62b_north', 'route_62b', 'all_days', 'Colon')
...
VALUES
    ...
    -- 62B: Minglanilla -> Seaside -> Colon
    ('trip_62b_north', '08:00:00', '08:05:00', 'stop_minglanilla', 1),
    ('trip_62b_north', '08:30:00', '08:35:00', 'stop_seaside', 2),
    ('trip_62b_north', '08:50:00', '08:55:00', 'stop_colon', 3)
